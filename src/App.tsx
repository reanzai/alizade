...
export default function App() {
  ...
  const [commands, setCommands] = useState<ChatCommand[]>([
    { id: '1', command: '!discord', response: 'Discord linkimiz: https://discord.gg/HQvynwfuTg', enabled: true },
